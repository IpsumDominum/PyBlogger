...
<h1 ><strong>Default Blog</strong><br></h1>
...
{% for post in posts %}
    <h6>#{{post['index']}} {{post['date']}}</h6>
    <a href="{{project_name}}/html/{{post['name']}}.html" class="stretched-link">{{post['name']}}</a>
{% endfor %}
</div>
<!-- End block
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
...
"""
#==========================================================================================================================
default_page_instructions = """# Dillinger
